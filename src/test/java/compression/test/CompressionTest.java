...
public class CompressionTest {
	...
	public void testResponseDeflated() throws IOException {
		// no compression
		Resty r = new Resty();
		String responseBody = r.text("https://www.whatsmyip.org/http-compression-test/").toString();
		...
		responseBody = r.text("https://www.whatsmyip.org/http-compression-test/").toString();
